...
describe('DeliveryClosed', () => {
  beforeEach(async () => {
    await truncate();
  });

  it('should be able to list closeds deliveries', async () => {
  ...
  it('should not be able to list closeds deliveries if delivery man not found', async () => {
